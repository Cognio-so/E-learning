...
const PPTXViewer = ({ 
  ...
  useEffect(() => {
    if (presentationUrl) {
      // Try to create a preview URL using Google Docs Viewer as fallback
      const googlePreviewUrl = `https://docs.google.com/viewer?url=${encodeURIComponent(presentationUrl)}&embedded=true`;
      setPreviewUrl(googlePreviewUrl);
    }
  }, [presentationUrl]);
