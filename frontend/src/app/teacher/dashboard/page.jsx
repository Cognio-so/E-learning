...
const TeacherDashboardPage = () => {
  ...
  const recentActivities = [
    ...
    },
    {
      ...
      description: "Assessment for Grade 7A",
      time: "6 hours ago",
      status: "alert"
    },
  ...
  const events = [
    { date: new Date(2024, 0, 15), title: "Math Quiz", type: "assessment" },
    { date: new Date(2024, 0, 18), title: "Parent Meeting", type: "meeting" },
    { date: new Date(2024, 0, 22), title: "Science Lab", type: "class" },
    { date: new Date(2024, 0, 25), title: "Grade Review", type: "review" },
  ]
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-gradient-to-br from-pink-50 via-white to-pink-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Header */}
      <motion.div
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white cursor-pointer" onClick={() => router.push("/teacher/reports")}>
              <Sparkles size={16} className="mr-2" />
              Check Reports
            </Button>
            <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white cursor-pointer" onClick={() => router.push("/teacher/schedule-class")}>
            ...
            <Card className="h-fit">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <CalendarIcon size={20} className="text-green-500 dark:text-green-400" />
              ...
              <CardContent>
                ...
                <Button variant="outline" className="w-full mt-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white hover:text-white cursor-pointer">
                  View Full Schedule
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.section variants={itemVariants}>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <Target size={20} className="text-red-500 dark:text-red-400"/>
                  <span>Quick Actions</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <Button onClick={() => router.push("/teacher/content-generator")} variant="outline" className="w-full justify-start">
                  <BookOpen size={16} className="mr-2 text-blue-500 dark:text-blue-400" />
                  Generate Lesson Plan
                </Button>
                <Button onClick={() => router.push("/teacher/assessment-generator")} variant="outline" className="w-full justify-start">
                  <PieChart size={16} className="mr-2 text-green-500 dark:text-green-400" />
                  Create Assessment
                </Button>
                <Button onClick={() => router.push("/teacher/reports")} variant="outline" className="w-full justify-start">
                  <BarChart3 size={16} className="mr-2 text-yellow-500 dark:text-yellow-400" />
                  View Analytics
                </Button>
                <Button onClick={() => router.push("/teacher/messages")} variant="outline" className="w-full justify-start">
                  <MessageSquare size={16} className="mr-2 text-purple-500 dark:text-purple-400" />
                  Student Messages
                </Button>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  {recentActivities.map((activity) => (
                    <div key={activity.id} className="flex items-start space-x-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activity.status === 'completed' ? 'bg-green-100' :
                      ...
                      <p className="text-[14px] font-medium text-primary truncate">{activity.title}</p>
